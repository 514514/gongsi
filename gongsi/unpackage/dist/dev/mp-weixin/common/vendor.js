  ...
  list: [
    {
      ...
      text: "首页",
      iconPath: "/static/zhuye1.png",
      selectedIconPath: "/static/zhuye.png"
    },
    {
      pagePath: "pages/chanpin/chanpin",
      text: "产品",
      iconPath: "/static/chanpin1.png",
      selectedIconPath: "/static/chanpin.png"
    },
    {
      pagePath: "pages/anlie/anlie",
      text: "案列",
      iconPath: "/static/anlie1.png",
      selectedIconPath: "/static/anlie.png"
    },
    {
      pagePath: "pages/home/home",
      text: "名片",
      iconPath: "/static/mingpian1.png",
      selectedIconPath: "/static/mingpian.png"
    }
  ]
};
...
const S = true, b = "mp-weixin", A = I([]), P = b, T = I('{\n    "address": [\n        "127.0.0.1",\n        "192.168.1.9"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "remote",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "C:/Users/李恋晨/Downloads/HBuilderX.3.8.4.20230531/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), C = I('[{"provider":"aliyun","spaceName":"fengguan","spaceId":"mp-99b2e5ac-5a60-4be9-9db2-1e4f8a8e94b9","clientSecret":"Y7eJcT8asPoWwu/MiU/Wiw==","endpoint":"https://api.next.bspapp.com"}]') || [];
let O = "";
try {
  O = "__UNI__8D65FA0";
} catch (e2) {
